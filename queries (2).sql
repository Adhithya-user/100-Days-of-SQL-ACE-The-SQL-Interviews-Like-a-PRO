...
-- Find employees Salary more than their managers Salary
-- Self join
-- same table but using twice e employee id and  m manager id refer 
...
select e.emp_id,e.emp_name,m.emp_name as manager_name,e.salary,m.salary as managers_salary from emp e
